...
const Dashboard = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      axios
        .post("https://backend-kappa-puce.vercel.app/cofees", data)
        .then((result) => {
          ...
          >
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 w-full gap-4">
              ...
              <div className="mb-2">
                ...
                <input
                  type="file"
                  {...register("P_url", { required: false })}
                  className="file-input w-full max-w-xs bg-[#fff] text-slate-600"
                />
              </div>
              <div className="mb-2">
                <label className="block mb-1 font-medium">
                ...
                <input
                  type="file"
                  {...register("Doc_1_PC", { required: false })}
                  className="file-input w-full max-w-xs bg-[#fff] text-slate-600"
                />
              </div>
              <div className="mb-2">
                ...
                <input
                  type="file"
                  {...register("Doc_2_PC", { required: false })}
                  className="file-input w-full max-w-xs bg-[#fff] text-slate-600"
                />
              </div>
              <div className="mb-2">
                ...
                <input
                  type="file"
                  {...register("Doc_3_PC", { required: false })}
                  className="file-input w-full max-w-xs bg-[#fff] text-slate-600"
                />
              </div>
              <div className="mb-2">
                ...
                <input
                  type="file"
                  {...register("Doc_4_PC", { required: false })}
                  className="file-input w-full max-w-xs bg-[#fff] text-slate-600"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              className="block w-full px-4 py-3 text-xl font-bold awesome-btn rounded-md  border-2 border-black bg-blue-950 hover:scale-105 duration-200"
            >
              Add new User
            </button>
          </form>
